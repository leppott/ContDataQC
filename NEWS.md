...
# Planned Updates
  ...
  - ~~Spell out “AW”" and other abbreviations (e.g., AirWater).
    20170308. On hold.~~

  - ~~Gaps in data not always evident in the plots. 20170308.~~

  - ~~Use futile.logger to better log output for user. Issue \#29.
    20170606.~~
...
2017-11-30
  ...
  - Export.StreamThermal
      ...
      - Add metric definition Excel file to extdata so can use when
...
2017-06-06
  ...
  - Report\_QC.rmd. Correct typo in “Flags” descriptions. Issue \#28.
    20170606.
...
2017-05-26
  ...
  - Time interval. Fixed calculation of time interval. Certain date time
    ...
    Report\_Aggregate.rmd, Report\_QC.rmd, and Report\_Stats.rmd.
    20170526.
...
2017-05-18
  ...
  - Config file. Upate Sensor Depth and Water Pressure display names.
    20170518.
...
2017-05-15
  ...
  - Fixed typo in finding time interval in markdown files;
    Report\_Aggregate.RMD, Report\_Stats.RMD, and Report\_QC.RMD.
    20170510.
