...
# ContData.env$myName.WaterLevel    <- paste("Water.Level.",ContData.env$myUnits.WaterLevel,sep="")
...
# ContData.env$myLab.WaterLevel     <- paste("Water Level (",ContData.env$myUnits.WaterLevel,")",sep="")
