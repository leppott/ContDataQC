...
#     use apply function to count number of records not equal to the expected value
    ...
    cat("\n")
    print(myDateRange.Target.Missing)
...
#       #
  ...
  #    print("days where not the expected number of records")
      ...
      myTable <- addmargins(table(data.import[,paste("Flag.Gross",i,sep=".")]),1)
      print(kable(t(as.matrix(myTable)), format = "markdown"))
        cat("\n\n")
      cat("#####Flags, Spike\n\n")
      
      myTable <- addmargins(table(data.import[,paste("Flag.Spike",i,sep=".")]),1)
      print(kable(t(as.matrix(myTable)), format = "markdown"))
        cat("\n\n")
      cat("#####Flags, RoC\n\n")
      
      myTable <- addmargins(table(data.import[,paste("Flag.RoC",i,sep=".")]),1)
      print(kable(t(as.matrix(myTable)), format = "markdown"))
        cat("\n\n")
      cat("#####Flags, Flat\n\n")
      
      myTable <- addmargins(table(data.import[,paste("Flag.Flat",i,sep=".")]),1)
      print(kable(t(as.matrix(myTable)), format = "markdown"))
        cat("\n\n")
