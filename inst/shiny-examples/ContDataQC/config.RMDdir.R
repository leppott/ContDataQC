...
# library.  The user has the ability to modify the values for names, units,
# QC thresholds, etc.
#
...
# #Data values only.  No functions.  Add to environment so only visible
# inside library.
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
