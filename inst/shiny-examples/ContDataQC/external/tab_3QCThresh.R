        ...
        , mainPanel(
          tabsetPanel(type = "tabs"
            ...
            , tabPanel("Evaluate Thresholds"
                      , p("Below is a link to R code to develop thresholds based on your own data.")
                      , p("The code is run in R and does not have a shiny interface.")
                      , p("The code provided 'as is'.  It may not run on your code for a number or reasons (e.g., sd = 0 where it is used as a denominator in a calculation.)")
                      , p("The author of the code is xxxxx.")
                      , br()
