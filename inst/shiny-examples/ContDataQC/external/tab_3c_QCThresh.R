            ...
            , tabPanel("Upload Custom Thresholds"
                       ,sidebarLayout(
                         sidebarPanel(
                           ...
                           , br()
                           , p("The following lists the Configuration file currently being used:")
            ...
            , tabPanel("Edit Thresholds"
                       ...
                       ,sidebarLayout(
                         sidebarPanel(#width = 5
                                     ...
                                     ,p("see boxes under each flag test type to the right at bottom of this page")
                                      ,h4("3. Save your changes")
                                      ,p(paste("Note: Save changes for one parameter at a time"))
                                      ,actionButton(inputId = "QC_SaveBttn"
                                                    , label = "Save changes")
                                      ,h4("4. Download your custom thresholds file")
                                      ,p(paste("Note: The downloaded file must be reuploaded in the next step"))
                                      ,downloadButton(outputId = "QC_Thresh_Download"
                                                      #, label = "Download custom thresholds file")
                                                      , label = "Download")
                                     , h4("5. Upload custom threshold file")
                                     , p("Go to the 'Upload Custom Thresholds' tab, browse to the custom thresholds file you downloaded above, upload that file, and then, under 'Main Functions', run the ‘QC raw data’ function to generate QC reports. If you skip this step, the default QC thresholds will be used.")
