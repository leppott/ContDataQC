...
You should also consider what units you’d like to use. If you are working with lakes and prefer to use meters over feet, click [here](https://github.com/leppott/ContDataQC/tree/dev_shinymods/Documents/Custom_QC_Files) to download a default configuration file that has been converted to meters. 
...
One of our lake RMN collaborators, Tim Martin from Minnesota DNR, has also developed a R script to help with threshold evaluation. Click [here](https://github.com/leppott/ContDataQC/tree/dev_shinymods/Documents/Custom_QC_Files) to download his R script. 

### Customizing and uploading the customized configuration file
Instructions

1. Click [here](https://github.com/leppott/ContDataQC/tree/dev_shinymods/Documents/Custom_QC_Files) to download the default configuration file (hydrologic units = feet)
