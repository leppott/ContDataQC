...
Click [here](PUT HYPERLINK HERE) to download a zipped file with a ready-made set of (empty) folders. Simply put the file in the desired location, unzip it and then replace ‘SiteX’ with the appropriate site name.
