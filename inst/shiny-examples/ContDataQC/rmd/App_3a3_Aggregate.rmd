...
**Example** [Aggregate output](Example_Aggregate.zip) [ZIP]
...
4.	After the function is done running, a ‘Download’ button will appear. Click this button. You will be prompted to save a zipped file named ‘Aggregate.date_time.’ Save it in the Data3_Aggregated folder.
