...
continue to gain experience QCing continuous data for the Regional Monitoring Network project. To date, we have worked primarily with thermal and hydrologic data, and more recently, dissolved oxygen 
...
download a list of example data qualifiers.

*	Leave missing data cells blank.

## Workflow

Click [here](Workflow_QC_report_20220824.pdf) [PDF] for a description of a common workflow
for reviewing the QC reports.

If you have a backlog of data files from multiple deployments and are wondering 
how to most efficiently QC the files, click [here](Workflow_DataPileup_20220824.pdf) [PDF] 
for a description of a workflow that has worked well.
...
leaf packs, dewatering, and dead batteries.

## Checking sensor data against other data sources

Some partners have been downloading data from nearby weather stations and USGS gages, as well as modeled
...
), and comparing those data to sensor measurements as part of their QC process.
Click [here](Daymet_Wx_Gage.zip) [ZIP] for instructional materials.
