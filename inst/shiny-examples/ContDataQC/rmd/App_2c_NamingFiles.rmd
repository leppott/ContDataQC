...
Example files from a RMN stream sties, where one temperature sensor was deployed
on land and the other in the water.  In the AW files, air and water sensore data
were combined into the same file.
...
# state directories
table.dir  <- "tables"
table.file <- "FileNaming_Streams_20240131.xlsx"
table.sheet  <- "Sheet1"
...
Example file for a lake RMN site where temperature sensors were deployed at 
multiple depths and DO sensors were also deployed.  The two types of sensors
overlapped at the 2M depth and the second part of the file name (DataType) was
used to distinguish between the two (TEMP vs. DO).
...
# state directories
table.dir  <- "tables"
table.file <- "FileNaming_Lakes_20240131.xlsx"
table.sheet  <- "Sheet1"
