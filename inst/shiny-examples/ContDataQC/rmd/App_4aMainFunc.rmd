...
Click [here](https://github.com/leppott/ContDataQC/tree/dev_shinymods/Documents/Run_Functions_Files) to download a PDF with instructions on how to set up Google Chrome so that it asks you where to save each file before downloading (which can be a big time-saver).
