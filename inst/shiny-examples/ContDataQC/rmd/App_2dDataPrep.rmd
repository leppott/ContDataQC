...
*	Time-saver tip: if you use Google Chrome as your internet browser, you can change its settings so that it asks what folder to download files to (versus files going to the default Download folder). Click here for instructions on how to set this up. Your files are now ready to be run through the QC function!
