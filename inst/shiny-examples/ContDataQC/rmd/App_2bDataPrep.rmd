...
the double-dash separator if desired by customizing the [configuration file](https://github.com/Blocktt/ShinyAppDocuments/tree/main/ContDataQC/Naming_Files)
