...
**Data summary and visualization:** The ContDataSumViz Shiny app, which was designed for data visualization and reporting for continuous monitoring data, has more summary and visualization options. A beta version of this Shiny app is available at: <a class="menu__link" 
href="https://contdatasumviz_2.app.cloud.gov/" target="_blank">ContDataSumViz<span class="usa-tag external-link__tag" title="Exit EPA Website">
                    <span aria-hidden="true">Exit</span>
                    <span class="u-visually-hidden"> Exit EPA Website</span>
                  </span>
                </a>

R code is available at: <a class="menu__link" href="https://github.com/USEPA/dmap-ContDataQCSumViz" target="_blank">GitHub<span class="usa-tag external-link__tag" title="Exit EPA Website">
                    <span aria-hidden="true">Exit</span>
                    <span class="u-visually-hidden"> Exit EPA Website</span>
                  </span>
                </a>
