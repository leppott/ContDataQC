...
![ContDataQC Shiny App workflow](RMD_Images/1_Overview_workflow_figure.jpg)
...
parameters that they desire by making edits to the <a href="www/Config_default.zip" target="_blank">configuration file</a>
, which can be viewed in R or in Notepad. 
