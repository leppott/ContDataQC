...
# OneEPA_template_for_ShinyApps_(update_title_on_line_28___UI_code_on_215___dateUpdated_on_441___server_code_on_457)_.R
# 2023-12-15
#~~~~~~~~~~~
# Using separate UI and Server files so commented out server code at bottom
# commented out require(shiny)
# Changed ui <- foo to shinyUI(foo) then added closing parenthesis at end
...
shinyUI(fluidPage(
  ...
  tags$head(
    ...
    tags$title('Continuous Data QC, Summary, and Statistics | US EPA'),
